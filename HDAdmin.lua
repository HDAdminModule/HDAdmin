...
local module = {
	...
	Function = function(speaker, args)
		...
		if success and hrp then
			main:GetModule("cf"):Notice(speaker, "HD Admin", "Successfully inserted asset: ".. assetId)
			...
			main:GetModule("cf"):Error(speaker, "HD Admin", "Failed to load: ".. assetId..". Can only load Catalog items or assets owned by the game owner.")
		end
	end;
	--
	};
